...
abstract class Stm {
	abstract void prettyprint(Visitor instance);
}
...
class CompoundStm extends Stm {
	...
	void prettyprint(Visitor instance) {
		stm1.prettyprint(Visitor.getInstance());
		System.out.print(" ; ");
		stm2.prettyprint(Visitor.getInstance());
	}
}
...
class EseqExp extends Exp {
	...
	void prettyprint() {		
		System.out.print("( ");
		stm.prettyprint(Visitor.getInstance());
		System.out.print(" , ");
		exp.prettyprint();
		System.out.print(" )");
	}
